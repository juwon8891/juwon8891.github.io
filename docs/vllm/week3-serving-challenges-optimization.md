...
![지연시간과 고객 만족도의 관계](/assets/images/posts/vllm-week3/latency-satisfaction.png)

곡선이 S자인 것이 요점이다. 양 끝의 평탄한 구간에서는 지연시간을 줄여도 만족도가 거의 변하지 않고, 가운데 급경사 구간에서만 투자 대비 효과가 크다. 우리 서비스가 이 곡선의 어디에 있는지가 최적화 우선순위를 정한다.
...
![AI 칩 매출의 훈련/추론 구성 변화 전망](/assets/images/posts/vllm-week3/ai-chip-revenue.png)

시장 전체가 2024년 약 $39B에서 2034년 약 $294B로 커지는데, 그 안에서 추론 비중까지 함께 올라간다. 즉 추론 지출은 비율로도 절대액으로도 훈련을 크게 앞지른다.
